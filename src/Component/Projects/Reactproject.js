    ...
    return (
      <div>
        ...
        <div className="card-body">
            ...
            <p>{item.title.length>=50?item.title.slice(0,50)+`...`:item.title} {item.title.length!==50&&<label htmlFor={`modelreact-${item.id}`} className="text-sm text-blue-500 cursor-pointer font-semibold">See more</label>}</p>
