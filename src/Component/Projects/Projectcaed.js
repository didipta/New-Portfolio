    ...
    return (
        <div>
            <div className="card bg-base-100 shadow-xl rounded-lg w-full max-w-2xl min-w-full">
                ...
                {
                    project?.videosrc&&<figure><iframe src={project.videosrc} className='w-full h-60' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></figure>
                }
            ...
            <div className="modal-box relative w-11/12 max-w-5xl">
                ...
                {
                    project?.videosrc&&<figure><iframe src={project.videosrc} className='w-full h-80' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></figure>
                }
            <div className="card-body">
            <div className="badge bg-pink-500 border-none text-white">{project.name}</div>
                <h2 className="card-title">
